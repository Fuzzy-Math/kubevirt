...
func (app *virtAPIApp) composeSubresources() {
	...
	for _, version := range v1.SubresourceGroupVersions {
		...
		subws.Route(subws.GET(rest.NamespacedResourcePath(subresourcesvmiGVR)+rest.SubResourcePath("sev/querylaunchmeasurement")).
		...
		subws.Route(subws.PUT(rest.NamespacedResourcePath(subresourcesvmiGVR)+rest.SubResourcePath("sev/injectlaunchsecret")).
