...
const (
	...
	// Reason means that VMI is not live migratable because it uses SEV Secure Nested Paging (SNP)
	VirtualMachineInstanceReasonSEVSNPNotMigratable = "SEVSNPNotLiveMigratable"
