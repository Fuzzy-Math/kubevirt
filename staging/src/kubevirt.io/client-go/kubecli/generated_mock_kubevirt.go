...
func (_m *MockVirtualMachineInstanceInterface) SEVFetchCertChain(name string) (v119.SEVPlatformInfo, error) {
	ret := _m.ctrl.Call(_m, "SEVFetchCertChain", name)
	ret0, _ := ret[0].(v119.SEVPlatformInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (_m *MockVirtualMachineInstanceInterface) SEVSetupSession(name string, sevSessionOptions *v119.SEVSessionOptions) error {
...
func (_m *MockVirtualMachineInstanceInterface) SEVInjectLaunchSecret(name string, sevSecretOptions *v119.SEVSecretOptions) error {
